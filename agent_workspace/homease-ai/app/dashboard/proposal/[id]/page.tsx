        ...
        <div className="min-h-screen bg-slate-950 text-white p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 mt-1">for {project?.title}</p>
                </div>
                ...
                <div className="mb-8 p-6 rounded-2xl bg-slate-800/50 border border-slate-700">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                        <div>
                            ...
                            <div className="text-xl font-bold">{assessment?.accessibility_score || 'N/A'}/100</div>
                        </div>
                        <div>
                            <div className="text-slate-400">Hazards Found</div>
                            <div className="text-xl font-bold">{assessment?.identified_hazards?.length || 0}</div>
                        </div>
                        <div>
                            <div className="text-slate-400">Budget Range</div>
                            <div className="text-xl font-bold">{project?.budget_range || 'Not specified'}</div>
                        </div>
                    </div>
                </div>
                ...
                {/* Scope Builder */}
                <div className="mb-8">
                    <h2 className="text-xl font-semibold mb-4">Scope Builder</h2>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            className="w-24 px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-right focus:border-blue-500 focus:outline-none"
                                        />
                                    </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="w-24 px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-right focus:border-blue-500 focus:outline-none"
                                />
                            </div>
                            <button
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <div className="text-sm text-slate-400">Total Proposal</div>
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl font-semibold text-lg transition-all"
                    >
