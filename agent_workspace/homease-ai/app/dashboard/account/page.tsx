      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="p-6 rounded-2xl bg-slate-800/50 border border-slate-700 mb-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 flex items-center justify-center text-2xl font-bold text-slate-900">
              {profile?.full_name?.charAt(0) || user.email?.charAt(0).toUpperCase()}
            </div>
            <div>
              <h2 className="text-xl font-semibold">{profile?.full_name || 'Set your name'}</h2>
              <p className="text-slate-400">{user.email}</p>
              <span className="inline-block mt-1 px-2 py-0.5 text-xs rounded-full bg-blue-500/20 text-blue-300 capitalize">
        ...
        <div className="p-6 rounded-2xl bg-slate-800/50 border border-slate-700">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-700/30">
              ...
              <span className="px-3 py-1 text-xs rounded-full bg-green-500/20 text-green-300">Verified</span>
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-700/30">
              <div>
